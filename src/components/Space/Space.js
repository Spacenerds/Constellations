    ...
    render() {
        return (
            <a-scene>
                ...
                <a-sphere src="#sunTexture" position="-500 2 -100" scale="109 109 109" rotation="0 45 45"></a-sphere>
                <a-sphere src="#mercuryTexture" position="-100 2 -100" scale="1.14 1.14 1.14" rotation="0 45 45"></a-sphere>
                <a-sphere src="#venusTexture" position="-150 2 -100" scale="2.85 2.85 2.85" rotation="0 45 45"></a-sphere>
                <a-sphere src="#earthTexture" position="-100 2 -100" scale="3 3 3" rotation="0 45 45"></a-sphere>
                <a-sphere src="#marsTexture" position="-50 2 -100" scale="1.59 1.59 1.59" rotation="0 45 45"></a-sphere>
                <a-sphere src="#jupiterTexture" position="50 2 -100" scale="33.57 33.57 33.57" rotation="0 45 45"></a-sphere>
                <a-sphere src="#saturnTexture" position="150 2 -100" scale="28.2 28.2 28.2" rotation="0 45 45"></a-sphere>
                <a-sphere src="#uranusTexture" position="300 2 -100" scale="12.12 12.12 12.12" rotation="0 45 45"></a-sphere>
                <a-sphere src="#neptuneTexture" position="400 2 -100" scale="11.64 11.64 11.64" rotation="0 45 45"></a-sphere>
                <a-sphere src="#plutoTexture" position="500 2 -100" scale="0.54 0.54 0.54" rotation="0 45 45"></a-sphere>
